...
pub const DEFAULT_STOPWORDS: &[&str] = &[
    ...
    "by", "from", "up", "down", "out", "off", "over", "under", "is", "are", "was", "were", "be",
    "been", "being", "am", "do", "does", "did", "have", "has", "had", "having", "i", "you", "he",
    "she", "it", "we", "they", "me", "him", "her", "us", "them", "my", "your", "his", "its", "our",
    "their", "this", "that", "these", "those", "here", "there", "what", "which", "who", "whom",
    "whose", "when", "where", "why", "how", "all", "any", "both", "each", "few", "more", "most",
    "other", "some", "such", "no", "nor", "not", "only", "own", "same", "so", "than", "too",
    "very", "can", "will", "just", "would", "should", "could", "now", "then", "also", "about",
    "into", "through", "after", "before", "again", "once", "because", "while", "get", "got",
    "going", "go", "really", "actually", "kind", "sort", "lot", "thing", "things", "okay", "ok",
    "yeah", "um", "uh", "like", "well", "right", "know", "think", "see", "want", "make", "made",
    "say", "said", "says", "one", "two", "us", "let", "gonna", "wanna",
];
...
mod tests {
    ...
    fn suggest_terms_drops_stopwords_and_ranks() {
        ...
        assert!(!ranked.iter().any(|(w, _)| w == "the" || w == "to"));
    }
