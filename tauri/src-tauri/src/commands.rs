...
mod tests {
    ...
    fn every_cmd_set_setting_arm_has_a_caller() {
        ...
        // cmd_set_live_shortcut → cmd_set_setting("live_transcript", ...)) are
        ...
        for path in walk_with_extensions(&rust_root, &["rs"]) {
            ...
            // internal callers like cmd_set_live_shortcut → cmd_set_setting.
    ...
    /// in commands.rs (e.g. cmd_set_live_shortcut) still count.
